...
@Component({
  template: `
    ...
    <h1 *requiredPolicies="''" id="empty-policy">Element</h1>
    <h1 *requiredPolicies="'aPolicy'" id="requires-one-policy">Element</h1>
    <h1
      *requiredPolicies="['aPolicy', 'anotherPolicy']"
      id="requires-more-policies"
    >
      Element
    </h1>
    <h1 *requiredPolicies="['!aNegatedPolicy']" id="requires-negated-policy">
      Element
    </h1>
    <h1
      *requiredPolicies="['aNotNegatedPolicy', '!aNegatedPolicy']"
