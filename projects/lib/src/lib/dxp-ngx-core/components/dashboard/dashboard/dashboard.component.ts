...
import { DxpLuigiContextService } from '../../../services';
...
export class DashboardComponent implements OnInit {
  ...
  constructor(private dxpContextService: DxpLuigiContextService) {}

  ngOnInit(): void {
    this.dxpContextService.contextObservable().subscribe((context) => {
